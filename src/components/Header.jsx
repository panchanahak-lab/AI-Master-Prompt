...
const Header = () => {
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-[#000000] border-b border-[#333333]">
            <div className="container-main mx-auto h-16 flex items-center justify-between">
                {/* LOGO */}
                <div className="text-[#00FF00] font-bold text-lg tracking-wider uppercase">
                    AI MASTER PROMPT
                </div>

                {/* NAV LINKS */}
                <nav className="hidden md:flex items-center gap-8">
                    <a href="#intro" className="text-gray-400 hover:text-[#00FF00] text-sm uppercase transition-colors">Who_It's_For</a>
